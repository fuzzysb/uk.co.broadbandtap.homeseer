...
function loadConfiguration(payload) {
    ...
    for (var key in payload) {
        try {
            ...
            if (elem.classList.contains("homeSeerServerIp")) { // File
                var elemFile = document.getElementById(elem.id + "homeSeerServerIp");
                elemFile.innerText = payload[key];
                if (!elemFile.innerText) {
                    elemFile.innerText = "No Server...";
                }
            }
            else if (elem.classList.contains("deviceName")) { // File
                var elemFile = document.getElementById(elem.id + "deviceName");
                elemFile.innerText = payload[key];
                if (!elemFile.innerText) {
                    elemFile.innerText = "No Device Name...";
                }
            }
            else if (elem.classList.contains("deviceId")) { // File
                var elemFile = document.getElementById(elem.id + "deviceId");
                elemFile.innerText = payload[key];
                if (!elemFile.innerText) {
                    elemFile.innerText = "No Device Id...";
                }
            }
            else if (elem.classList.contains("onValue")) { // File
                var elemFile = document.getElementById(elem.id + "onValue");
                elemFile.innerText = payload[key];
                if (!elemFile.innerText) {
                    elemFile.innerText = "No On Value...";
                }
            }
            else if (elem.classList.contains("offValue")) { // File
                var elemFile = document.getElementById(elem.id + "offValue");
                elemFile.innerText = payload[key];
                if (!elemFile.innerText) {
                    elemFile.innerText = "No On Value...";
                }
